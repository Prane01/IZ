...
void create_csv_file(const char* path, const char* fileName) {
	...
	std::ofstream file(filepathlocation, std::ios::binary);
	...
	*/
	...
	sLine.append(
		"Parent BOM ID,Child BOM ID,Assembly(A)/Component(C),Level,Element Effectivity,"
		"Variant,Rule Configured By,ID,Revision,Revision Name,Description,Is Negative,"
		"SAP Transfer Required,SAP Transfer Status,ERP Plant,Gold Business Enterprise(GBE),"
		"Line of Business(LOB),Inventory Unit Of Measure,Purchase Unit of Measure,"
		"Managing Location,Maturity,Net Weight,Part Category,Accolade Project ID,"
		"Product Hierarchy,Design Authority,Strategic Business Unit(SBU),"
		"Strategic Business Group(SBG),Weight Unit,Usage,Packing List,All Notes,"
		"Conversion factor,Has Substitutes,Substitute,Has Global Alternates,"
		"Item Has Global Alternates,Global Alternate List,Suppressed,Hon Notes,"
		"Reference Designator,Sequence,Quantity,Release Status,Date Released,"
		"Release Effectivity,Owner,Group ID,Last Modifying User,Is Variant Item,"
		"Active Arrangement,Vendor Parts,Trace Link,HEC,TEC,Government Classification,"
		...
		"Creation_Date,Substitute List,Unit Of Measure,Partners,End Item Assembly State,"
		"Pack Count,TCUID\n"
	);
